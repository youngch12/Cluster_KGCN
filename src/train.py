...
def construct_feed_dict(adj_entity, adj_relation, data, start, end, placeholders):
    ...
    relations_indices = np.array(relations_indices)
    ...
    print("\n")
    print("neighbors_indices.shape:", neighbors_indices.shape)
    print("entities_indices.shape:", entities_indices.shape)
    print("relations_indices.shape:", relations_indices.shape)
